...
const Mission = () => {
  ...
  const {ref:m_one,inView:mOneVisible} = useInView();

  return (
    <div ref={m_one}  className='mission-container'>
      <img src={mission_bg} />
      <div className='mission-container-item'>
          <div className={mOneVisible?'m-item-container slide_down':'m-item-container'}>
