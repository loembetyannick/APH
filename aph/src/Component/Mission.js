...
import {text_data} from '../features/TextData.js'
  ...
  return (
    <div className='mission-container'>
      ...
      <div className='mission-container-item'>
        ...
        <MissionStep image={no1} text={text_data[0].text}/>
        <MissionStep image={no2} text={text_data[1].text}/>
        <MissionStep image={no3} text={text_data[2].text}/>
      </div>
    </div>
  )
}
