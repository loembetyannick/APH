...
export const text_data = [
    ...
    {
        text: "Provided a very professional and friendly service. Communication was prompt and the job was completed efficiently and to a very high standard. Extremely pleased with the finished product and would 100% recommend",
        name: "Rachel"
    },
    {
        text: "Completed multiple repairs for a family member. Great communication, tidy, competitively priced and clearly takes pride in his work. Fantastic service would highly recommend",
        name: "Scott"
    },
]